    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "757966651365631",
               appSecret: "5a4f862e059cb9d711d3f2335ce1b2a4");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "108634986948-69failiqcgupjm79b001093qkpljl4nl.apps.googleusercontent.com",
                ClientSecret = "XYWb-bi19sqmXCSSrpq1Ix0r"
            });
        }
    }
}