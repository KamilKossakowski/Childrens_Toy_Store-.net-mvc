...
namespace Childrens_Toy_Store.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private ruleuserwejscie dbruls = new ruleuserwejscie();
        ...
        private async Task<bool> IsCaptchaValid(string response)
        {
            try
            {
                var secret = "6Ld_VcwUAAAAAFgY6FvSYXKkRCuVPdwnhZMcTK0_";
